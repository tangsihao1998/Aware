        ...
        return (
            <div className="footer-container">
                ...
                <div className="footer1">
                    <div><img className="Logo" src={process.env.PUBLIC_URL + "/images/Logo/logo.png"} srcSet={process.env.PUBLIC_URL + "/images/Logo/logo@2x.png 2x,images/Logo/logo@3x.png 3x"} 
